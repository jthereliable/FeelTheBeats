...
/** ArtistRequests indexes **/
db.getCollection("ArtistRequests").ensureIndex({
  "_id": NumberInt(1)
},[
...
/** ArtistRequests records **/
db.getCollection("ArtistRequests").insert({
  "_id": ObjectId("51b12bd5d34a153e0593f5aa"),
  "name": "Test",
  "requester": {
    "uid": 1,
    "name": "UserName"
  },
  "text": "Some text about artist",
  "url": "Some URL",
  "user": {
    "uid": 1,
    "name": "UserName"
